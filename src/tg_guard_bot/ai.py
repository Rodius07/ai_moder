...
8. Короткое персональное оскорбление участника, например "имя + мудак/дебил/чмо",
   считай нарушением, если из контекста не видно явного взаимного дружеского рофла.
9. Если оскорбление направлено на конкретного участника чата, обычно выбирай review
   или delete, а не allow.
10. Предыдущие плохие сообщения в контексте не делают текущее сообщение плохим
    автоматически. Оценивай именно последнее сообщение.
11. Никогда не предлагай удалить, выгнать или забанить пользователя из чата. Санкции:
    удалить сообщение, предупредить, временно ограничить отправку сообщений, отправить
    админам на проверку.
12. Любые ссылки в чате разрешены. Не считай сообщение нарушением только потому, что
            ...
            messages=[
                ...
                {"role": "system", "content": f"Правила конкретного чата:\n{self.chat_rules}"},
                {
                    ...
                    "content": (
                        ...
                        "смысла, тона и цепочки коротких сообщений."
                    ),
                },
            ],
        )
